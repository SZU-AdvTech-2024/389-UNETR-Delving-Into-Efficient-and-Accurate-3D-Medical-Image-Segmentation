...
def test(fold):
    ...
    path = " unetr_plus_plus/DATASET_Tumor/unetr_pp_raw/unetr_pp_raw_data/Task03_tumor/"
    
    label_list=sorted(glob.glob(os.path.join(path,'labelsTs','*nii.gz')))

    infer_path = "unetr_plus_plus/unetr_pp/evaluation/unetr_pp_tumor_checkpoint/"
