...
DATASET_PATH=/raid/sunbin/DATASET_Tumor
...
python ../unetr_pp/inference/predict_simple.py -i /raid/sunbin/DATASET_Tumor/unetr_pp_raw/unetr_pp_raw_data/Task003_tumor/imagesTs -o ../unetr_plus_plus/unetr_pp/evaluation/unetr_pp_tumor_checkpoint/inferTs -m 3d_fullres  -t 3 -f 0 -chk model_final_checkpoint -tr unetr_pp_trainer_tumor
